...
class CaptchaBuilder implements CaptchaBuilderInterface
{
    ...
    protected function writePhrase($image, $phrase, $font, $width, $height)
    {
        ...
        $size = $width / $length - $this->rand(0, 3) - 1 +3;
        $box = \imagettfbbox($size, 0, $font, $phrase);
        $textWidth = $box[2] - $box[0];
        $textHeight = $box[1] - $box[7];
        $x = ($width - $textWidth) / 2 - 14 - 4;
        ...
        $font = [
            '2' => __DIR__ . '/Font/f/gulim.ttc',
            '4' => __DIR__ . '/Font/f/gulim.ttc',
            '5' => __DIR__ . '/Font/f/calibril.ttf',
            '6' => __DIR__ . '/Font/f/HTOWERT.TTF',
            '7' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            '8' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            '9' => __DIR__ . '/Font/f/HTOWERT.TTF',
            'б' => __DIR__ . '/Font/f/Sahadeva Regular.ttf',
            'в' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            'r' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            'д' => __DIR__ . '/Font/f/DejaVuSansMono.ttf',
            'ж' => __DIR__ . '/Font/f/BOOKOS.TTF',
            'к' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            'л' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            'м' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            'н' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            'п' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            'р' => __DIR__ . '/Font/f/Gungsuh-03.ttf',
            // 'с' => __DIR__ . '/Font/f/batang.ttc',
            'с' => __DIR__ . '/Font/f/BOOKOS.TTF',
            'т' => __DIR__ . '/Font/f/Gungsuh-03.ttf'
            // 'г' => __DIR__ . '/Font/captcha1'.'.ttf',
            // 'ж' => __DIR__ . '/Font/captcha1'.'.ttf'
            // 'т' => __DIR__ . '/Font/f/Sahadeva Regular.ttf'
        ...
        for ($i=0; $i<$length; $i++) {
            ...
            $box = \imagettfbbox($size, 0, $f, $symbol);
            $w = $box[2] - $box[0];
            $angle = $this->rand(-$this->maxAngle, $this->maxAngle);
            $offset = $this->rand(-$this->maxOffset, $this->maxOffset);
            // $font
            echo "wtf", $f, "\n";
            \imagettftext($image, $size, $angle, $x, $y + $offset, $col, $f, $symbol); // HERE! select font!
            $x += $w;
        }
    ...
    public function build($width = 150, $height = 40, $font = null, $fingerprint = null)
    {
        ...
        if ($font === null) {
            $font = __DIR__ . '/Font/captcha1'.'.ttf';
        }
